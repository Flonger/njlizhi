...
class PlayerTools {
  ...
  final currentSongSubject = new BehaviorSubject<Map>.seeded({});
  ...
  List<Map> get songArr => _songArr;

  set songArr(List<Map> songArr) {
    _songArr = songArr;
  }
  ...
  // 设置数据源
  setSongs([List<Map> songs, int index = 0]) {
    this.songArr.clear();
  ...
  /// 播放
  Future<int> play(Map song) async {
